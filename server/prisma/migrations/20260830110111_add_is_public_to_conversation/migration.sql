...
INSERT INTO "new_Conversation" ("allowStaffPin", "createdAt", "description", "icon", "id", "isArchived", "isPinnedTop", "isReadOnly", "name", "ownerId", "parentId", "type") SELECT "allowStaffPin", "createdAt", "description", "icon", "id", "isArchived", "isPinnedTop", "isReadOnly", "name", "ownerId", "parentId", "type" FROM "Conversation";
