...
const THEMES = [
  ...
  { key: "crimson",  label: "Crimson",   rail: "#1A0A0A", sidebar: "#2D1010", brand: "#EF4444", description: "Vivid Red" },
  { key: "fuchsia",  label: "Fuchsia",   rail: "#2A0A2E", sidebar: "#3D1045", brand: "#D946EF", description: "Vivid Magenta" },
